...
tail -n /etc/passwd : Display the last 10 lines of /etc/passwd
head -n /etc/passwd : Display the first 10 lines of /etc/passwd
...
echo -en "" | tail --lines=1 iacta >> iacta  : Write a script that duplicates
